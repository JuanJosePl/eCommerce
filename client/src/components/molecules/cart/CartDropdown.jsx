...
const CartDropdown = ({ isOpen, onClose }) => {
  ...
  const total = cartItems.reduce((sum, item) => {
    if (item && item.producto && item.producto.precio) {
      return sum + item.producto.precio * (item.cantidad || 0);
    }
    return sum;
  }, 0);
        ...
        >
          ...
          {isLoading ? (
            ...
            <>
                ...
                {cartItems.map((item) => {
                  ...
                  return (
                    <div
                      ...
                      className="flex items-center justify-between py-2 border-b border-input"
                    >
              ...
              <div className="p-4 border-t border-input bg-white dark:bg-gray-800">
                {" "}
                {/* Cambiado a bg-white para modo claro */}
